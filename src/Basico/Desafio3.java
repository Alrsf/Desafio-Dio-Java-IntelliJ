...
/*Imagine o seguinte cenário, você desenvolveu uma máquina de  teletransporte no tempo que pode ser usada no máximo três vezes,
...
ir 5 anos para o futuro e, depois, voltar 9 anos para o passado. Dessa forma, você terminaria quatro anos no passado, em 2012.
Também poderia fazer três viagens, todas indo para o futuro, usando os créditos em qualquer ordem, terminando em 2042.

Neste desafio, dados os valores dos três créditos da máquina, seu programa deve dizer se é ou não possível viajar no tempo
...
public class Desafio3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (a + b == c || a + c == b || a == c || a == b || c == b || b + c == a)  //complete com o código nos espaços em branco
